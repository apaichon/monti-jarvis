...
| 48 | [48-conversation-auto-register-app-version-spec.md](48-conversation-auto-register-app-version-spec.md) | 53 | Conversation auto-register email OTP + app version on UI | `approved` |
...
**Sprint 53:** Design pack **approved** — [48-conversation-auto-register-app-version-spec.md](48-conversation-auto-register-app-version-spec.md); workflow §120–122; ER/API/UX Sprint 53; UX T53/C53/A53. [SPRINT-053](../03-sprints/SPRINT-053.md) · [FEAT-0045](../01-features/FEAT-0045-conversation-auto-register-app-version.md). Worktree `.worktrees/SPRINT-053`.
