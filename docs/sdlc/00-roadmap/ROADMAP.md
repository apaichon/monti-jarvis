...
| **46** | **Platform / Tenant / Growth** | **Tenant referral affiliate program with configurable bonus-quota rewards and referral usage tracking** | **M** | **9, 10, 13, 31, 45** · [SPRINT-046](../03-sprints/SPRINT-046.md) · in_progress |
...
## Active: SPRINT-046 — Tenant Referral Affiliate Program and Bonus Quota
...
**Depends:** 9, 10, 13, 31, 45 · **Status:** in_progress; foundation slice active
