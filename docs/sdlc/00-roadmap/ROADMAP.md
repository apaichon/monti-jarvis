...
| **54** | **Customer / Platform** | **Customer portal: pick tenant from list to call (no `tenant_id` query string required)** | **J** | **1, 5, 6, 20, 21, 38, 53** · merged · [FEAT-0045](../01-features/FEAT-0045-customer-portal-tenant-list.md) · [SPRINT-054](../03-sprints/SPRINT-054.md) · [DES-0049](../02-design/49-customer-portal-tenant-list-spec.md) |
...
## Merged: SPRINT-054 — Customer Portal Tenant List to Call (No `tenant_id` Query)
...
URL · **Depends:** 1, 5, 6, 20, 21, 38, 53 · **Status:** merged to main · **Feature:** [FEAT-0045](../01-features/FEAT-0045-customer-portal-tenant-list.md) · **Design:** [DES-0049](../02-design/49-customer-portal-tenant-list-spec.md) · **Sprint:** [SPRINT-054](../03-sprints/SPRINT-054.md)
