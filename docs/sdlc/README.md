...
**Latest shipped:** [`SPRINT-058`](03-sprints/SPRINT-058.md) portal UI language selector · **v2.31.0** · [`SPRINT-057`](03-sprints/SPRINT-057.md) logo/social preview · **v2.30.0**

**Current focus:** planned S60–S62 (Gemini key · top-bar status · referral redeem) · residual S45 UAT · S49 held

**Parallel build:** `.worktrees/SPRINT-060-062` · `docs/sprint-060-062-plan`

**Planned next:** SPRINT-060–062 (design approved in worktree) · S59 call UX (local) · residual S45 UAT
