...
**Current sprint:** Sprint 31 — Platform billing, quota, and AI infrastructure cost usage (**planned**)

**Parallel build:** _none_

**Latest shipped:** [`SPRINT-030`](03-sprints/SPRINT-030.md) — Platform overall call-center statistics · **v2.11.0**

**Planned next:** Sprint 31 — Platform billing, quota, and AI infrastructure cost usage
