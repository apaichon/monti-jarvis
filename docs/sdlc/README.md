...
**Current sprint:** Sprint 47 — Langfuse Real-Time LLM Observability and Evaluation (**backlog**)

**Current sprint:** Sprint 45 — AiaaS Packages and Usage Reconciliation (**in_progress** residual)

**Parallel build:** [`SPRINT-048`](03-sprints/SPRINT-048.md) — Product web growth (**in_progress**, worktree)

**Latest shipped:** [`SPRINT-046`](03-sprints/SPRINT-046.md) — Referral attribution and qualification foundation, partial; manual UAT deferred · **v2.19.0**

**Planned next:** Sprint 47 — Langfuse Real-Time LLM Observability and Evaluation

**Planned next:** Sprint 46 residual / Sprint 47 Langfuse · Sprint 48 product web is open in parallel
