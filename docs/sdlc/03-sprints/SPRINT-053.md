...
| --- | --- | --- |
| Feature | [FEAT-0045](../01-features/FEAT-0045-conversation-auto-register-app-version.md) | planned |
| Deep spec | **`approved`** | [DES-0048](../02-design/48-conversation-auto-register-app-version-spec.md) |
...
| Clash with require-workforce-auth | Spec co-existence rules in DES-0048 |
