...
**Current sprint:** Planned `SPRINT-055` call-center stats group by topic · residual S45 UAT. Latest shipped: `SPRINT-054` **v2.27.0** · `SPRINT-053` **v2.26.0** · `SPRINT-051` **v2.25.0** · `SPRINT-052` **v2.24.0**. S49 held.
