...
**Current sprint:** Sprint 44 — Customer Generative AI (**backlog**). Latest shipped: `SPRINT-043` v2.17.0 tenant AI/config extensibility. Backlog: **S44** customer generative AI (Claude/Codex/Antigravity/Grok CLI → HTML/image/canvas/link/report/doc). Parallel build: none.
