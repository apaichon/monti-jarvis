...
**Current sprint:** Design-approved `SPRINT-054` customer portal tenant list (no required `?tenant_id=`) · planned `SPRINT-053` auto-register + app version · planned `SPRINT-055` stats by topic · residual S45 UAT. Latest shipped: `SPRINT-052` **v2.24.0**. S49 held.
