...
**Current sprint:** Merged `SPRINT-053` auto-register + app version · merged `SPRINT-054` customer portal tenant list · planned `SPRINT-055` stats by topic · residual S45 UAT. Latest shipped: `SPRINT-051` **v2.25.0** commercial · `SPRINT-052` **v2.24.0**. S49 held.
