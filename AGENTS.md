...
**Current sprint:** Sprint 47 — Langfuse Real-Time LLM Observability and Evaluation (**backlog**). Latest shipped: `SPRINT-046` v2.19.0 partial referral attribution/qualification foundation; manual UAT deferred with the close remark “test later”. Carry-over: TASK-0166, TASK-0167, TASK-0168. Parallel build: none.
