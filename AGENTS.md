...
**Current sprint:** Sprint 32 — Platform billing usage readiness and reconciliation (**planned**). Latest shipped: `SPRINT-031` v2.12.0 platform billing, quota, and AI usage. Parallel build: none.
