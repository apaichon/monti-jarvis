...
**Current sprint:** Sprint 33 — Partition, Index, and Hardening (**planned**). Latest shipped: `SPRINT-039` v2.15.0 theme branding & colors. Backlog added: **S42** bug fix (session/menu/nav/scope) · **S43** embed auth + config groups + tenant Gemini/prompt/tools/skills. Parallel build: none.
