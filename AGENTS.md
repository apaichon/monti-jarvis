...
**Current sprint:** Sprint 33 — Partition, Index, and Hardening (**planned**). Latest shipped: `SPRINT-037` v2.14.0 embed framework SDKs (Vue · React · Svelte · Web Component). Parallel build: none.
