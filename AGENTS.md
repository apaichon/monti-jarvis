...
**Current sprint:** `SPRINT-007` — Platform Admin: KYC Tenant (v0.8.0) — review `pending_kyc` registrations

**Shipped:** v0.7.0 `SPRINT-006` · v0.6.0 `SPRINT-005` · v0.5.0 `SPRINT-004` · v0.4.0 `SPRINT-003` · v0.3.0 `SPRINT-002` · v0.2.0 `SPRINT-001` · v0.1.0 prototype `SPRINT-000-prototype.md`
