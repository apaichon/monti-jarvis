...
**Current sprint:** Sprint 33 — Partition, Index, and Hardening (**planned**). Latest shipped: `SPRINT-042` v2.16.0 tenant UX bugfix. Next backlog: **S43** embed auth + config groups + tenant Gemini/prompt/tools/skills. Parallel build: none.
