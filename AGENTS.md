...
**Current sprint:** Design-approved `SPRINT-056` caller desk branding + mic/speaker · planned `SPRINT-055` stats by topic · residual S45 UAT. Latest shipped: `SPRINT-054` **v2.27.0** · `SPRINT-053` **v2.26.0**. S49 held.
