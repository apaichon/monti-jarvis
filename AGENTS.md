...
**Current sprint:** Sprint 31 — Platform billing, quota, and AI infrastructure cost usage (**planned**). Latest shipped: `SPRINT-030` v2.11.0 platform overall call-center statistics. Parallel build: none.
