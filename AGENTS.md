...
**Current sprint:** Sprint 43 — Embed Auth, Config Groups, and Tenant AI Extensibility (**planned**). Latest shipped: `SPRINT-042` v2.16.0 tenant UX bugfix. Parallel build: none.
