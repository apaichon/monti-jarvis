...
**Current sprint:** Sprint 46 — Tenant Referral Affiliate Program and Bonus Quota (**backlog**). Latest shipped: `SPRINT-045` v2.18.1 partial package/quota/ledger slice; manual UAT deferred. Carry-over: TASK-0166, TASK-0167, TASK-0168. Parallel build: none.
