...
**Current sprint:** Sprint 47 — Langfuse Real-Time LLM Observability and Evaluation (**backlog**). Latest completed package: `SPRINT-046` rebuilt to 17/17 points with referral bonus quota, reporting, and tenant UX; v2.20.0 release pending manual UAT. Parallel build: none.
